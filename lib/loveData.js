...
export const loveData = {
  ...
  introLines: [
    "Hey Sameer...",
    "I made something...",
    "For the boy who changed my life.",
    "I hope this makes you smile.",
  ],

  // Love stats (animated counters)
  stats: [
    { label: "Days Together", value: 742, icon: "calendar" },
    { label: "Hours Together", value: 17808, icon: "clock" },
    { label: "Messages Sent", value: 48291, icon: "message" },
    { label: "Photos Taken", value: 1284, icon: "camera" },
    { label: "Calls", value: 612, icon: "phone" },
    { label: "Trips Together", value: 9, icon: "map" },
    { label: "Laughs Shared", value: 99999, icon: "smile" },
  ...
  loveLetter: {
    title: "A letter, from Abheer — to Sameer",
  ...
  // Bucket list
  bucketList: [
    { text: "Travel to a country neither of us can spell", done: true },
    { text: "Watch the sunrise from a hilltop", done: true },
    { text: "Cook a full dinner together, no phones", done: false },
    { text: "Long midnight road trip with our songs", done: false },
    { text: "Dance in the rain", done: false },
    { text: "Build a treehouse. Or an apartment. Same energy.", done: false },
    { text: "Grow old and still hold hands crossing the street", done: false },
  ],
  ...
  proposal: {
    ...
    celebration: "I knew you'd choose me ❤️",
  },
