...
export const loveData = {
  ...
  //   body: "My dearest Sameer,\n\nIf love had a shape, I think it would look exactly like your smile—the kind that lights up your whole face and somehow makes everything around it brighter.\n\nEver since you walked into my life, even the most ordinary days have become memories worth keeping. Mornings feel a little happier because of you. Nights feel calmer after hearing your "good night." And the quiet moments we share—the ones where we don't even need words—have become my favorite place in the world.\n\nI don't have poems big enough for you, so I built this instead. A tiny universe. Every pixel here whispers the same three words.\n\nYours, endlessly,\n— Sonu ❤️",
  // },
